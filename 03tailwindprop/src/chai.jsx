function Card(username="chaiaurcode") {
    console.log(username);
    
    return <> <div className="flex font-sans">
    <div className="flex-none w-56 relative">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTD6SSM2SX8Lvvp4POc8I4hmT2AOx29ZudYQQ&s" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
    </div>
